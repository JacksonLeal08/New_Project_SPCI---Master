  ...
  const statusVivo = useMemo(() => {
    ...
    if (rawStatus.includes('NÃO CONFORME') || rawStatus.includes('REPROVADO') || rawStatus.includes('INTERDITADO')) {
      return {
        ...
        badgeBg: 'bg-red-950/80 text-red-400 border-red-700',
        glowClass: 'border-red-600 shadow-[0_0_30px_rgba(220,38,38,0.35)]',
        isOk: false,
        isVencido: true
      };
    }
    ...
    if (isVencido) {
      return {
        ...
        badgeBg: 'bg-red-950/90 text-red-400 border-red-700 animate-pulse',
        glowClass: 'border-red-600 shadow-[0_0_35px_rgba(220,38,38,0.45)] ring-2 ring-red-500/50',
        isOk: false,
        isVencido: true
      };
    }
    ...
    if (isAVencer) {
      return {
        ...
        glowClass: 'border-amber-500 shadow-[0_0_25px_rgba(245,158,11,0.25)]',
        isOk: true,
        isVencido: false
      };
    }
    ...
    return {
      ...
      glowClass: 'border-emerald-500 shadow-[0_0_30px_rgba(16,185,129,0.25)]',
      isOk: true,
      isVencido: false
    };
  }, [asset]);
...
_Mensagem gerada automaticamente via Portal Público SPCI Master._`;
    ...
    return (
      <div className="min-h-screen bg-slate-950 text-slate-100 font-mono flex flex-col justify-between p-4 sm:p-6 lg:p-8">
        <div className="max-w-xl mx-auto w-full my-auto py-12 text-center space-y-6">
          <div className="w-16 h-16 bg-red-950/80 border border-red-700/80 text-red-500 rounded-3xl mx-auto flex items-center justify-center text-3xl shadow-2xl">
            ⚠️
          </div>
          <div className="space-y-2">
            <span className="px-3 py-1 bg-red-950/60 border border-red-800 text-red-400 text-[10px] uppercase font-bold tracking-widest rounded-full">
              Ativo Não Localizado
            </span>
            <h1 className="text-2xl font-black uppercase text-white font-['Hanken_Grotesk']">
              Identificador [{searchedId.toUpperCase()}]
            </h1>
            <p className="text-xs text-slate-400 font-sans max-w-md mx-auto leading-relaxed">
              O equipamento informado não foi encontrado na base de dados ativa ou o código de patrimônio foi digitado incorretamente.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
            <Link
              href="/public/ativos"
              className="w-full sm:w-auto px-6 py-3 bg-red-600 hover:bg-red-500 text-white rounded-xl text-xs font-bold uppercase tracking-wider transition-all shadow-lg shadow-red-900/40"
            >
              Consultar Catálogo de Ativos
            </Link>
            <Link
              href="/login"
              className="w-full sm:w-auto px-6 py-3 bg-slate-900 hover:bg-slate-800 border border-slate-800 text-slate-300 rounded-xl text-xs font-bold uppercase tracking-wider transition-all"
            >
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 font-mono flex flex-col justify-between selection:bg-red-600 selection:text-white">
      ...
      <header className="border-b border-slate-900/90 bg-slate-950/80 backdrop-blur-md sticky top-0 z-40 px-4 sm:px-8 py-3.5 flex items-center justify-between">
        <Link href="/public/ativos" className="flex items-center gap-3 group">
          ...
          <div>
            <span className="font-['Hanken_Grotesk'] text-sm font-black uppercase tracking-wider text-white block">
              SPCI MASTER
            </span>
        ...
        <div className="flex items-center gap-2">
          <Link
            href="/public/ativos"
            className="hidden sm:inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[11px] font-bold text-slate-400 hover:text-white bg-slate-900 hover:bg-slate-800 border border-slate-800 transition-all uppercase"
          >
          ...
          <Link
            ...
            className="inline-flex items-center gap-1 px-3 py-1.5 rounded-lg text-[10px] font-bold text-emerald-400 bg-emerald-950/60 hover:bg-emerald-900/60 border border-emerald-800/80 transition-all uppercase"
      ...
      <main className="max-w-4xl mx-auto w-full px-4 sm:px-6 py-6 sm:py-10 space-y-6">
        ...
        <div className={`bg-slate-900/70 border rounded-3xl p-5 sm:p-8 backdrop-blur-xl transition-all duration-300 relative overflow-hidden ${statusVivo.glowClass}`}>
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-6 border-b border-slate-800/80">
            <div className="space-y-2">
              ...
              <h1 className="text-3xl sm:text-4xl font-black uppercase tracking-tight text-white font-mono flex items-center gap-3">
            ...
            <div className="bg-slate-950/80 border border-slate-800/90 rounded-2xl p-4 flex items-start gap-3 md:max-w-xs shrink-0">
          ...
          <div className={`mt-5 p-4 rounded-2xl border flex items-center gap-3.5 ${
            ...
            <div className="text-xs font-sans">
              ...
              <span className="text-slate-300 text-[11px] leading-relaxed">{statusVivo.subtext}</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3.5 sm:gap-4 mt-6">
            ...
            <div className="bg-slate-950/70 border border-slate-800/80 p-3.5 rounded-2xl space-y-1">
              ...
              <p className="text-xs font-black text-white uppercase font-mono">
            ...
            <div className="bg-slate-950/70 border border-slate-800/80 p-3.5 rounded-2xl space-y-1">
              ...
              <p className="text-xs font-black text-white uppercase font-mono truncate">
            ...
            <div className={`p-3.5 rounded-2xl space-y-1 border ${
              statusVivo.isVencido ? 'bg-red-950/40 border-red-700/60 text-red-300' : 'bg-slate-950/70 border-slate-800/80'
            }`}>
              <span className="text-[9px] font-bold text-slate-400 uppercase tracking-wider block">
            ...
            <div className="bg-slate-950/70 border border-slate-800/80 p-3.5 rounded-2xl space-y-1">
              ...
              <p className="text-xs font-black text-emerald-400 uppercase font-mono truncate">
          ...
          {asset.fotoUrl && (
            <div className="mt-6 pt-6 border-t border-slate-800/80 flex flex-col sm:flex-row items-center gap-4">
              <div
                onClick={() => setIsPhotoZoomOpen(true)}
                className="relative w-28 h-28 rounded-2xl overflow-hidden border border-slate-700 bg-slate-950 shrink-0 cursor-pointer group shadow-lg"
              >
                <img
                  src={asset.fotoUrl}
              ...
              <div className="space-y-1 text-center sm:text-left">
                ...
                <button
                  type="button"
                  onClick={() => setIsPhotoZoomOpen(true)}
                  className="text-xs text-red-400 hover:text-red-300 font-bold underline inline-flex items-center gap-1 cursor-pointer pt-1"
                >
          ...
          <div className="mt-8 pt-6 border-t border-slate-800/80 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <button
              ...
              className="w-full sm:w-auto px-6 py-3.5 bg-gradient-to-r from-red-600 to-rose-600 hover:from-red-500 hover:to-rose-500 text-white font-bold text-xs uppercase tracking-wider rounded-2xl shadow-xl shadow-red-950/50 flex items-center justify-center gap-2 cursor-pointer transition-all active:scale-95"
            >
        ...
        <div className="bg-gradient-to-r from-emerald-950/40 via-slate-900 to-slate-900 border border-emerald-500/30 rounded-3xl p-5 sm:p-6 backdrop-blur-xl flex flex-col sm:flex-row items-center justify-between gap-4 shadow-lg shadow-emerald-950/20">
          <div className="flex items-center gap-4 text-left">
            <div className="w-12 h-12 rounded-2xl bg-emerald-950/80 border border-emerald-700/80 text-emerald-400 flex items-center justify-center shrink-0 text-xl shadow-md">
              🛠️
            </div>
            <div>
              <div className="flex items-center gap-2">
                <span className="px-2 py-0.5 rounded-full text-[9px] font-black uppercase tracking-wider bg-emerald-950/80 text-emerald-300 border border-emerald-800">
                  Acesso Operacional
                </span>
              ...
              <h3 className="text-sm font-black uppercase text-white font-mono mt-1">
          ...
          <Link
            href={`/inspecao/${encodeURIComponent(asset.idAtivo || asset.id)}`}
            className="w-full sm:w-auto px-6 py-3 bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs uppercase tracking-wider rounded-2xl shadow-lg shadow-emerald-950/50 flex items-center justify-center gap-2 transition-all active:scale-95 shrink-0"
          >
        ...
        {isExtintor && (
          <div className="bg-slate-900/60 border border-slate-800/90 rounded-3xl overflow-hidden backdrop-blur-md">
            <button
              type="button"
            ...
            >
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-red-950/80 border border-red-800 text-red-500 flex items-center justify-center shrink-0">
            ...
            <AnimatePresence>
              {isClassesAccordionOpen && (
                <motion.div
                  ...
                  className="border-t border-slate-800/80 p-5 sm:p-6 space-y-6"
                >
                  {/* Classes de Fogo */}
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs font-sans">
                    <div className="p-4 bg-slate-950/80 border border-emerald-900/50 rounded-2xl space-y-1.5">
                      <span className="px-2 py-0.5 bg-emerald-950 text-emerald-400 border border-emerald-800 rounded-md font-mono font-bold text-[10px] uppercase">
                        Classe A
                      </span>
                      <h5 className="font-bold text-white">Sólidos Combustíveis</h5>
                      <p className="text-[11px] text-slate-400 leading-relaxed">
                        Madeira, papel, tecido e fibras que queimam em superfície e profundidade.
                      </p>
                    </div>

                    <div className="p-4 bg-slate-950/80 border border-red-900/50 rounded-2xl space-y-1.5">
                      <span className="px-2 py-0.5 bg-red-950 text-red-400 border border-red-800 rounded-md font-mono font-bold text-[10px] uppercase">
                        Classe B
                      </span>
                      <h5 className="font-bold text-white">Líquidos Inflamáveis</h5>
                      <p className="text-[11px] text-slate-400 leading-relaxed">
                        Óleos, gasolina, solventes e graxas que queimam em superfície sem resíduos.
                      </p>
                    </div>

                    <div className="p-4 bg-slate-950/80 border border-blue-900/50 rounded-2xl space-y-1.5">
                      <span className="px-2 py-0.5 bg-blue-950 text-blue-400 border border-blue-800 rounded-md font-mono font-bold text-[10px] uppercase">
                        Classe C
                      </span>
                      <h5 className="font-bold text-white">Equipamentos Elétricos</h5>
                      <p className="text-[11px] text-slate-400 leading-relaxed">
                  ...
                  <div className="space-y-3">
                    <h5 className="text-xs font-black uppercase text-slate-300 font-mono">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 text-center text-xs font-sans">
                      <div className="p-3 bg-slate-950/80 border border-slate-800 rounded-xl space-y-1">
                        ...
                        <p className="font-bold text-white text-[11px]">Puxe a Trava</p>
                        <p className="text-[10px] text-slate-400">Rompa o lacre plástico</p>
                      </div>
                      <div className="p-3 bg-slate-950/80 border border-slate-800 rounded-xl space-y-1">
                        ...
                        <p className="font-bold text-white text-[11px]">Aponte o Bico</p>
                        <p className="text-[10px] text-slate-400">Para a base do fogo</p>
                      </div>
                      <div className="p-3 bg-slate-950/80 border border-slate-800 rounded-xl space-y-1">
                        ...
                        <p className="font-bold text-white text-[11px]">Aperte o Gatilho</p>
                        <p className="text-[10px] text-slate-400">Comprima a alavanca</p>
                      </div>
                      <div className="p-3 bg-slate-950/80 border border-slate-800 rounded-xl space-y-1">
                        ...
                        <p className="font-bold text-white text-[11px]">Movimento em Leque</p>
                        <p className="text-[10px] text-slate-400">Varra de um lado ao outro</p>
                      </div>
                    </div>
                  </div>
                </motion.div>
        ...
        {isHidrante && (
          <div className="bg-slate-900/60 border border-slate-800/90 rounded-3xl p-5 sm:p-6 backdrop-blur-md space-y-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-blue-950/80 border border-blue-800 text-blue-500 flex items-center justify-center shrink-0">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs font-sans">
              <div className="p-3.5 bg-slate-950 border border-slate-800 rounded-2xl flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-blue-400 shrink-0" />
                <span className="text-slate-200">2x Mangueiras 15m</span>
              </div>
              <div className="p-3.5 bg-slate-950 border border-slate-800 rounded-2xl flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-blue-400 shrink-0" />
                <span className="text-slate-200">1x Esguicho Regulável</span>
              </div>
              <div className="p-3.5 bg-slate-950 border border-slate-800 rounded-2xl flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-blue-400 shrink-0" />
                <span className="text-slate-200">2x Chaves Storz</span>
              </div>
              <div className="p-3.5 bg-slate-950 border border-slate-800 rounded-2xl flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-blue-400 shrink-0" />
                <span className="text-slate-200">Válvula Angular 45º</span>
              </div>
            </div>
          </div>
        )}
        ...
        {isBomba && (
          <div className="bg-slate-900/60 border border-slate-800/90 rounded-3xl p-5 sm:p-6 backdrop-blur-md space-y-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-emerald-950/80 border border-emerald-800 text-emerald-500 flex items-center justify-center shrink-0">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs font-sans">
              <div className="p-3.5 bg-slate-950 border border-slate-800 rounded-2xl space-y-1">
                <span className="text-[10px] text-slate-400 uppercase font-mono font-bold block">Pressão Nominal</span>
                <p className="text-sm font-black text-white font-mono">100 - 125 PSI</p>
              </div>
              <div className="p-3.5 bg-slate-950 border border-slate-800 rounded-2xl space-y-1">
                <span className="text-[10px] text-slate-400 uppercase font-mono font-bold block">Bomba Jockey</span>
                <p className="text-sm font-black text-emerald-400 font-mono">Operacional / Automática</p>
              </div>
              <div className="p-3.5 bg-slate-950 border border-slate-800 rounded-2xl space-y-1">
                <span className="text-[10px] text-slate-400 uppercase font-mono font-bold block">Bomba Principal</span>
                <p className="text-sm font-black text-white font-mono">Prontidão Standby</p>
              </div>
            </div>
          </div>
        )}
        ...
        {isReportModalOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/85 backdrop-blur-md font-sans">
            <motion.div
              ...
              className="bg-slate-900 border border-slate-700/80 rounded-3xl w-full max-w-lg shadow-2xl p-6 relative overflow-hidden space-y-5"
            >
              {/* Barra superior */}
              ...
              <div className="flex items-start justify-between pb-3 border-b border-slate-800">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-red-950 border border-red-800 text-red-500 flex items-center justify-center text-xl shrink-0">
                    🚨
                  </div>
                  <div>
                    ...
                    <p className="text-[11px] text-slate-400">
                      Ativo: <strong className="text-white font-mono">{asset.idAtivo || asset.patrimonio}</strong> ({asset.location})
                    </p>
                  </div>
                </div>
              ...
              {reportSuccessFeedback ? (
                <div className="py-8 text-center space-y-3">
                  <div className="w-12 h-12 rounded-full bg-emerald-950 text-emerald-400 mx-auto flex items-center justify-center text-2xl border border-emerald-800 animate-pulse">
                    ✓
                  </div>
                  <p className="text-sm font-bold text-white">{reportSuccessFeedback}</p>
                </div>
              ) : (
                <form onSubmit={handleSubmitReport} className="space-y-4 text-xs">
                  <div>
                    <label className="font-bold text-slate-300 uppercase tracking-wider text-[10px] block mb-2 font-mono">
                  ...
                  <div>
                    <label className="font-bold text-slate-300 uppercase tracking-wider text-[10px] block mb-1 font-mono">
                    ...
                    <textarea
                      ...
                      className="w-full px-3 py-2 bg-slate-950 border border-slate-800 rounded-xl text-slate-100 placeholder-slate-500 focus:outline-none focus:border-red-600 text-xs"
                    />
                  </div>

                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                    <div>
                      <label className="font-bold text-slate-400 uppercase tracking-wider text-[9px] block mb-1 font-mono">
                        Seu Nome (Opcional)
                      </label>
                      <input
                        type="text"
                  ...
                  <div className="pt-2 flex items-center justify-end gap-2.5">
                    <button
                      type="button"
                      onClick={() => setIsReportModalOpen(false)}
                      className="px-4 py-2.5 rounded-xl border border-slate-800 text-slate-400 hover:text-white hover:bg-slate-800 uppercase font-bold text-[10px] cursor-pointer"
                    >
                      Cancelar
                    </button>
                    <button
                      ...
                      className="px-5 py-2.5 rounded-xl bg-red-600 hover:bg-red-500 text-white uppercase font-bold text-[11px] flex items-center gap-1.5 shadow-lg shadow-red-950/50 cursor-pointer disabled:opacity-50"
                    >
